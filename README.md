...
| Preview  | Description |
|---|---|
| <img src="https://demoapus2.com/landing-page/houzing/images/home-9.png" alt="Houzing product page demo" width="250"><br/>[Source](houzing-s.netlify.app)| <b>Houzing product page</b><br/>Online home sale page<br/> <br/> [📃 Repo](https://github.com/Sardor0795/Houzing) - [🌐 Netlify](https://houzing-s.netlify.app/) - ⌚ 8 hours 20 minutes<br/><br/><b>Specific features: </b>The property page setting provides you a complete options panel. For example, you can list and manage properties, define page layouts, Images gallery, Optimized for mobile, Ratings & Reviews|
